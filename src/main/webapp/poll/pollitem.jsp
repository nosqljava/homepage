...
<% 
	...
	PollDTO dto = service.read(num); //한건의 설문정보
	Vector<PollitemDTO> list = service.itemList(num); //항목들
...
<div class="container mt-2">
 ...
 %> 
   ...
   <label class="m-10">설문내용 : <%=dto.getQuestion() %></label>
...
<%
   for(int i=0; i<list.size() ; i++){
     ...
     <input type="checkbox" class="form-check-input" id="check<%=i %>" name="itemnum" 
     value="<%=idto.getItemnum()%>">
...
<%   }else{   %>   
    ...
    <div class="form-check">
  	<input type="radio" class="form-check-input" id="radio<%=i %>" name="itemnum" 
  	value="<%=idto.getItemnum()%>">
